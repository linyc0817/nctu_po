            ...
            <div class="navbox1_2">
                ...
                <div id="vision_page" class="_hide">   <!-- 點擊展開出右大梯形 -->
                    ...
                    <div class="cb3">
                        ...
                        <div class="cb3-title">忠誠</div>忠於憲法及法律，忠於國家及全民;重視榮譽、誠信、誠實並應具道德感與責任感。<br><br>
                        <div class="cb3-title">專業</div>以謙虛的態度，終身學習，積極充實職務所需之知識技能，並熟悉主管法令及相關政<br>&nbsp;&nbsp;策措施，以提供全民第一流的公共服務。<br><br>
                        <div class="cb3-title">效能</div>運用有效方法，簡化行政程序;研修相關法令、措施應符合成本效益要求;發揮執行<br>&nbsp;&nbsp;力，以提高行政效率與工作績效，達成政策目標。<br><br>
                        <div class="cb3-title">關懷</div>時時以民眾福祉為念，親切提供服務;對人民之需要及所遭遇之困難與問題，能以同<br>&nbsp;&nbsp;理心設身處地著想，並提供必要之協助與照護，以增進其利益。</div>
                    </div>
                </div>
                <!-- hover出梯形二 -->
                <div id="navboxw1_2">
